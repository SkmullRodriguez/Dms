        ...
        <div class="global">
            <div class="fila1"> 
                <div class="center-block jumbotron">
                    <IMG SRC="../imagenes/sonrisa8.jpg" WIDTH=300 HEIGHT=220 BORDER=2 VSPACE=3 HSPACE=3" ALIGN="right" class="img-thumbnail">
                    <h1>Introduccion al Nivel 3</h1>
                <p>En este nivel usted como usuario podra aprender la forma de como expresar frases de cantidad  numeros 
                    con lenguaje de señas.<br><br>
                
                    Da clic en iniciar y aperturate a tu experiencia.</p><br>
                <a href="http://localhost:8080/integrador/nivel3/iniciar.php" class="btn btn-primary btn-lg" role="button">Iniciar</a><br><br>
                <a href="http://localhost:8080/integrador/nivel3/evaluacion.php" class="btn btn-primary btn-lg" role="button">Evaluacion</a>
