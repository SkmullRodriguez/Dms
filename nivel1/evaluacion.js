...
function nivel(){
    window.location.replace("http://localhost:8080/integrador/nivel2/introduccion.php");
}
function Redire1(){
    window.location.replace("http://localhost:8080/integrador/nivel1/iniciar.php");
}
