...
//                                foreach ($nom as $nombre){-->
        ...
        <div class="global">
            <div class="fila1"> 
                ...
                <a href="http://localhost:8080/integrador/nivel4/iniciar.php" class="btn btn-primary btn-lg" role="button">Iniciar</a><br><br>
                <a href="http://localhost:8080/integrador/nivel4/evaluacion.php" class="btn btn-primary btn-lg" role="button">Evaluacion</a>
...
<!--            
           ...
           <div class="fila3">
                ...
                <ul class="pager">
                    <div class="col1">
                          <button type="button" class="btn btn-default">Instrucciones</button>
